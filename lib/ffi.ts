...
type MapFFIType<T extends FFIType> =
	T extends typeof FFIType.void ? void :
...
type LastFunctionParameterIsVaradic<T extends FFIFunctionDefinition> =
	...
	: ArrayLength<T["parameters"]> extends 1
		? T["parameters"][0] extends typeof FFIType.varadic ? true : false
	: ArrayLength<T["parameters"]> extends 2
		? T["parameters"][1] extends typeof FFIType.varadic ? true : false
	: ArrayLength<T["parameters"]> extends 3
		? T["parameters"][2] extends typeof FFIType.varadic ? true : false
	: ArrayLength<T["parameters"]> extends 4
		? T["parameters"][3] extends typeof FFIType.varadic ? true : false
	: never; 
...
export type FFIFunction<T extends FFIFunctionDefinition> = 
	...
	: ArrayLength<T["parameters"]> extends 3
		? LastFunctionParameterIsVaradic<T> extends false
			? (arg0: MapFFIType<T["parameters"][0]>, arg1: MapFFIType<T["parameters"][1]>, arg2: MapFFIType<T["parameters"][2]>) => MapFFIType<T["returnType"]>
			: (arg0: MapFFIType<T["parameters"][0]>, arg1: MapFFIType<T["parameters"][1]>, ...args: unknown[]) => MapFFIType<T["returnType"]>
	: ArrayLength<T["parameters"]> extends 4
		? LastFunctionParameterIsVaradic<T> extends false
			? (arg0: MapFFIType<T["parameters"][0]>, arg1: MapFFIType<T["parameters"][1]>, arg2: MapFFIType<T["parameters"][2]>, arg3: MapFFIType<T["parameters"][3]>) => MapFFIType<T["returnType"]>
			: (arg0: MapFFIType<T["parameters"][0]>, arg1: MapFFIType<T["parameters"][1]>, arg2: MapFFIType<T["parameters"][2]>, ...args: unknown[]) => MapFFIType<T["returnType"]>
	: (...args: unknown[]) => MapFFIType<T["returnType"]>;
...
function ffiTypeToKoffiType(type: FFIType): string {
	switch (type) {
		...
		case FFIType.int32: return "int";
		case FFIType.string: return "str";
		case FFIType.varadic: return "...";
	}
}

export function ffiLoad<T extends FFILibraryDefinition>(path: string, definition: Readonly<T>): FFILibrary<T> {
	...
	for (const [ funcName, func ] of Object.entries(definition.functions)) {
		...
		const koffiFunc = koffiLib.func(funcName, ffiTypeToKoffiType(func.returnType), func.parameters.map(ffiTypeToKoffiType));
